        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {activeAnalysis ? (
            ...
            <div className="flex flex-col items-center justify-center h-64 text-center p-8 animate-fade-in">
              <svg className="animate-spin w-12 h-12 mb-4 text-emerald-500" fill="none" viewBox="0 0 24 24">
                <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
              </svg>
              <p className="text-sm font-bold text-emerald-600">Analisando...</p>
              <p className="text-xs text-slate-400 mt-2">Processando a conversa com IA</p>
            </div>
          ) : (
